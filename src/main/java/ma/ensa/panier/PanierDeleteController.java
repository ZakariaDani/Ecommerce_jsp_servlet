...
/**
 * Servlet implementation class PanierDeleteController
 */
public class PanierDeleteController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PanierDeleteController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(refArticle != null) {
			article.stock(refArticle, "DOWN", panier);
			panier.delete();
		}
